...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Trang bị bảo hộ - Chỉnh sửa</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="card-body"> 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" style="" id="personal_id" name="personal_id">
                                        <option value="{{ $protection->personal_id }}">{{ $protection->personal->ho_ten }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="" id="warehouse_id" name="warehouse_id">
                                        <option value="{{ $protection->warehouse_id }}">{{ $protection->warehouse->vat_tu }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="so_luong" name="so_luong" value="{{ old('so_luong') ?? $protection->so_luong }}">
                                </div>                    
                            <!-- /.card-body --> 
