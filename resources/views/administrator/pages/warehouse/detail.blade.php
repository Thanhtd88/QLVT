            ...
            <!-- left column -->
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.warehouse.update', ['warehouse' => $warehouse->id]) }}">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="row">
                                    ...
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" name='ma_vat_tu' value="{{ old('ma_vat_tu') ?? $warehouse->ma_vat_tu }}">
                                            @error('ma_vat_tu')
                                                <span style="color: red; font-size: 14px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" name='vat_tu' value="{{ old('vat_tu') ?? $warehouse->vat_tu }}">
                                            @error('vat_tu')
                                                <span style="color: red; font-size: 14px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="name" name='don_vi_tinh' value="{{ old('don_vi_tinh') ?? $warehouse->don_vi_tinh }}">
                                            @error('don_vi_tinh')
                                                <span style="color: red; font-size: 14px">{{ $message }}</span>
                                            @enderror
                                        </div>
