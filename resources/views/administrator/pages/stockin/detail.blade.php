            ...
            <!-- left column -->
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.stock-in.update', ['stock_in' => $stock_in->id]) }}">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3">
                                            <div class="input-group date reservationdate" id="ngay_nhap_kho" data-target-input="nearest">
                                                ...
                                                <input name="ngay_nhap_kho" type="text" value="{{ old('ngay_nhap_kho') ?? date("d-m-Y", strtotime($stock_in->ngay_nhap_kho)) }}" class="form-control datetimepicker-input" data-target="#ngay_nhap_kho" @error('ngay_nhap_kho') placeholder="{{ $message }}" style="background: red;" @enderror/>
                                    ...
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3 box-vihicle">
                                            ...
                                            <select class="form-control select2" style="" id="" name="warehouse_id">
                                                <option value="{{ $stock_in->warehouse_id }}">{{ !is_null($stock_in->warehouse_id) ? $stock_in->warehouse->vat_tu : '' }}</option>
                                    ...
                                    <div class="box1 col-md-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" id="name" name='so_luong_nhap' value="{{ old('so_luong_nhap') ?? $stock_in->so_luong_nhap }}">
                                            @error('so_luong_nhap')
                                                <span style="color: red; font-size: 14px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="box1 col-md-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" id="name" name='don_gia_nhap' value="{{ old('don_gia_nhap') ?? $stock_in->don_gia_nhap }}">
                                            @error('don_gia_nhap')
                                                <span style="color: red; font-size: 14px">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="box1 col-md-12">
                                        <div class="input-group mb-3 box-vihicle">
                                            ...
                                            <select class="form-control select2" style="" id="" name="supplier_id">
                                                <option value="{{ $stock_in->supplier_id }}">{{ !is_null($stock_in->supplier_id) ? $stock_in->supplier->ten_ncc : '' }}</option>
